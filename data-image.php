...
<body>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
                <p><a href="add-image.php" class="btn">Tambah Data</a></p>
                <br>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="delete-image.php?idp=<?php echo $row['image_id'] ?>"
    ...
    <!-- footer -->
    <footer class="footer">
        <p>&copy; 2023 Created with ❤️ by Alira. All Rights Reserved.</p>
